...
$qry = "SELECT * FROM `buy` INNER JOIN products ON products.ID_Products = buy.ID_Products WHERE ID_Customer = :id_cust";
$parm = array(
    "id_cust" => $_SESSION["user_id"],
);
                    ...
                    <?php foreach ($products as $product) : ?>
                        <div class="product_container">
                            ...
                            <div class="product_down">
                                ...
                                <a href="/main/delProd.php?ID_Buy=<?= $product['ID_Buy'] ?>">
                                    <img src="/img/product/32.svg" alt="">
                                </a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                <button class="btn" href="#">Оплатить</button>
            </div>
        </section>
    </main>
    <footer>
